...
Participant **Yevgeniy Samyshkin**
...
hist(mydata_daily$steps_daily, breaks=60, main="The number of steps taken daily", ylab="Frequency, days in dataset", xlab="Steps per day", col="blue", border ="white")
